...
<div style="font-size: 12px; margin-bottom: 4px;">心法总纲（建立认知）</div>

* **AI 优先：** 凡是 AI 能做的，就不要人工做
* **提问至上：** 一切问题问 AI
* **编程本质：** 数据与函数即是编程的一切
* **目的主导：** 开发过程中的一切动作围绕“目的”展开

<div style="font-size: 12px; margin-bottom: 4px;">战略规划（思考路径）</div>
...
<div style="font-size: 12px; margin-bottom: 4px;">战术执行（交互技巧）</div>

* **上下文要素：** 上下文是 Vibe Coding 的第一性要素，垃圾进，垃圾出，精品进，精品出
* **黄金圈法则：** 多问 AI “是什么”、“为什么”、“怎么做”
* **过程刻画：** 输入、处理、输出，刻画整个过程

<div style="font-size: 12px; margin-bottom: 4px;">优化与心态（提效避坑）</div>

* **奥卡姆剃刀定理：** 如无必要，勿增代码
* **极致专注：** 极致的专注可以击穿代码，一次只做一件事（神人除外）
...
* **目标边界：** 一句话目标 + 非目标
* **正交原则：** 正交性，功能不要太重复了（这个分场景）
* **拒绝造轮：** 能抄不写，不重复造轮子，先问 AI 有没有合适的仓库，下载下来改
* **文档投喂：** 一定要看官方文档，先把官方文档爬下来喂给 AI
* **职责分离：** 按职责拆模块
* **接口为先：** 接口先行，实现后补
* **单点修改：** 一次只改一个模块
* **文档驱动：** 文档即上下文，不是事后补
